...
def test_selected_model(directory, model_name):
    models_path = os.path.join(directory,  "trained_models")
    ...
    try:
        ...
        category_index = label_map_util.create_category_index_from_labelmap(os.path.join(directory, 'annotations', 'label_map.pbtxt'))
        ...
        for nr in range(0, len(images_names)):
            ...
            viz_utils.visualize_boxes_and_labels_on_image_array(
                ...
                min_score_thresh=.01,
                agnostic_mode=False)
            image_name = model_name + images_names[nr][:-4] + '.png'
            cv2.imwrite(os.path.join(directory, "images_to_test", image_name), image_np_with_detections)
            print("DONE")
...
directory = os.getcwd()
model_name = os.listdir(os.path.join(directory, "trained_models"))
print(model_name[0])
test_selected_model(directory, model_name[0])
